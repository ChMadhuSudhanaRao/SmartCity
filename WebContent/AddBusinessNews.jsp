    ...
    <main>
        ...
        <div class="popular-location border-bottom section-padding40">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="section-tittle text-center mb-80">
                            <h2>Add Business News in City of Destiny</h2>
                ...
                <div class="container" align="center" style=" margin-left: 110px;">
		  			...
		  			%>
				<h3 style="color: green;">${message}</h3><br><br>
				<form action="BusinessController" enctype="multipart/form-data" method="post">
				
				<table class="table thead table-bordered" style="border:black;outline-color: black;font-family: monospace;table-layout: auto;" >
				...
				<tbody>
					...
					<tr>
				      <td >
				      	<input type="text" name="newsHeading"/>
				      </td>
				      <td>
