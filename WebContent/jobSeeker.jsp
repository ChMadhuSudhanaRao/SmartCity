...
<body>
    ...
    <main>
        ...
        <div class="popular-location border-bottom section-padding40">
                ...
                <div class="row">
                   ...
                   HttpSession se=request.getSession();
		  			...
		  			if (se.getAttribute("user")!=null) {
						...
						List<JobSeeker> jlist=JobSeekerDAOLayer.jobList();
	       ...
	       <div class="card" style="width:500px; height:500px; margin-top: 10px">
	      <img src='<c:out value="data:image/jpg;base64,${j.base64Image}"> </c:out>' alt="" class="card-img-top" style="width:500px; height:150px;">
	      <div class="card-body" style="width:auto; height:auto;">
	     
	      <hr>
	        <h3 class="card-title"><c:out value="${j.getCompanyName()}"></c:out></h3><br>
			<hr>
	        <p style="  margin-top:10px; font-weight: bold; "><c:out value="${j.getJobTitle()}"></c:out></p>
	  		<hr>
	        <a class="btn-danger"style=" font-weight: bold; margin-left:185px;" href='<c:out value="${j.getLink()}"></c:out>'> Apply Here</a><br>
	        <hr>
	        <p class="card-text"><c:out value="${j.getDescrp()}"></c:out></p>
