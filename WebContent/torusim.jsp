<!doctype html>
<%@page import="com.smartcity.DAOLayer.TourismDAOLayer"%>
<%@page import="com.smartcity.model.Tourism"%>
    ...
    <main>
        ...
        <div class="popular-location border-bottom section-padding40">
                   ...
                   <%
		                   HttpSession se=request.getSession();
				  			...
				  			if (se.getAttribute("user")!=null) {
								...
								List<Tourism> tlist=TourismDAOLayer.placesList();
	      ...
	      <div class="card-body" style="width:auto; height:auto;">
	        <h3 class="card-title"><c:out value="${p.getpName()}"></c:out></h3>
	        <p style=" font-weight: bold; "><c:out value="${p.getLocation()}"></c:out></p>
	        <p class="card-text"><c:out value="${p.getDescrp()}"></c:out></p>
