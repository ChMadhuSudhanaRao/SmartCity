<!doctype html>
<%@page import="com.smartcity.DAOLayer.StudentDAOLayer"%>
<%@page import="com.smartcity.model.Student"%>
...
<body>
    ...
    <main>
        ...
        <div class="popular-location border-bottom section-padding40">
                ...
                <div class="row">
                   ...
                   HttpSession se=request.getSession();
                     ...
                     if(se.getAttribute("user")!=null){
                    	...
                    	List<Student> slist=StudentDAOLayer.eduList();
	       ...
	       <div class="card" style="width:500px; height:450px; margin-top: 10px">
	      <img src='<c:out value="data:image/jpg;base64,${p.base64Image}"> </c:out>' alt="" class="card-img-top" style="width:500px; height:450px;">
	      <div class="card-body" style="width:auto; height:auto;">
	        <h3 class="card-title"><c:out value="${p.getCollegeName()}"></c:out></h3>
	        <span style=" font-weight: bold; "><c:out value="${p.getCollegeAdd()}"></c:out></span><br>
	        <span class="card-text"><c:out value="${p.getCollegeDescrp()}"></c:out></span>
